                        ...
                        <div class="form-group">
                            <form action="{{route('shop.order.index')}}" method="GET">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search" required placeholder="Search Order" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <div class="table-responsive table-bordered">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('shop.order.edit',$item->id )}}" class="btn btn-dribbble btn-sm mr-2" title="edit">
