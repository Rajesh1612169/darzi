...
@section('content')
    ...
    ">
            ...
            <div class="col-md-9">
                <a href="{{ route('user.create.address') }}" class="generic-btn mb-3 red-hover-btn text-uppercase float-right btn-sm" tabindex="0">
                    Create New Address
                </a>
                <div class="table-content table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="product-price">Postal Code</th>
