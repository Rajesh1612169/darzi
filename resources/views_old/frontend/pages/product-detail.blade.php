    ...
    <div class="modal fade" id="productCustomization" tabindex="-1" role="dialog" aria-labelledby="productCustomizationTitle" aria-hidden="true">
        <div class="modal-product-customization modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="coller_modal" tabindex="-1" role="dialog" aria-labelledby="coller_modalTitle" aria-hidden="true">
        <div class="modal-product-customization-pages modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row m-2">
                        <div class="col-md-4" style="position:relative;background: #e1e1e1;border-radius: 8px;">
                            ...
                            <img style="position: absolute; left: 100px; width: 30%; top: 0px;" src="https://bombayshirts.picarioxpo.com/bsc-zoom-collar-bottom-single-button.pfs?1=1&width=500&p.tn=newbutton_grey.jpg&p.c=,d3d3d3,ffffff&p.tr=True,True" alt="">
                        </div>
                        <div class="col-md-8">
                            <div class="row">
