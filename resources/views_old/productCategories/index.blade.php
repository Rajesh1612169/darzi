...
{{--                <a href="" class="">+Create</a>--}}
                <div class="row">
                        ...
                        <div class="form-group">
                            <form action="{{route('category.index')}}" method="GET">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search" required placeholder="Search Product Category" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    ...
                    <div class="col-md-8">
                        <a href="{{route('category.create')}}" type="button" class="btn btn-primary btn-fw float-right mb-3 pt-2 pb-2">Create Category</a>
                    </div>
                </div>
