...
//        dd($user);
        ...
        $cart_items = DB::table('shopping_cart as sc')
            ...
            ->where('sc.user_id', '=', $user_id)
            ->get();
        $sizing_details = DB::table('user_sizes')->where('user_id', '=', $user_id)->get();
        $profile = DB::table('users')
            ->where('id', '=', $user_id)
            ->first();
//        dd($cart_items,$profile);

        return view('frontend.pages.shop_order', ['cart_items'=>$cart_items, 'profile'=>$profile, 'sizing_details' => $sizing_details]);
    }
